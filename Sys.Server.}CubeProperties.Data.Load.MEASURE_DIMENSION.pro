601,100
602,"Sys.Server.}CubeProperties.Data.Load.MEASURE_DIMENSION"
562,"SUBSET"
586,"}Cubes"
585,"}Cubes"
564,
565,"p_=_[D4E=i=?ic5EaLRZAIAxwY84St6AVmOk52TOWgGs?3Y@jc@nCj@5?TBBhv1_;dZJBjiMbdSTd8RAm\22@]MtGTE\OFLO2ZSfLJcuL3:odQQB6NaGibSWcMds7k[rTDcHXn_lYA64xLL0_0:yP:Vatc0ln^?8FPOM<LTbxz:fs8qVuW51ZJMi=SooQ:09`Ra5l<=D"
559,1
928,0
593,
594,
...
nDimensions = 0;
While (nCount <= 256);
     If (TabDim(vCube, nCount) @= '');
         nDimensions = nCount - 1;
         nCount = 256;
     Endif;
     nCount = nCount + 1;
End;
...
CellPutS(sMeasureDimension, cCubeTarget, vCube, 'MEASURES_DIMENSION');
