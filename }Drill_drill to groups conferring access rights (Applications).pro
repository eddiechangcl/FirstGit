601,100
602,"}Drill_drill to groups conferring access rights (Applications)"
562,"VIEW"
586,"}APQ Security Effective Client Application Folder Permissions"
585,"}APQ Security Effective Client Application Folder Permissions"
564,
565,"jOUUwQY07\aAk2qez6BbTYNjw[MeaccRy6xbQ4VPgvsu:DBmMIR\bX]Hqa[]1LJ7P2>ta[SFl<J997s41`=18fTvaUbH>EmO:@m[AePsQB:\uzESr8XCECr?NxlZtgb<jW8pSiu?z_rysnXL2NqWqqG5ilK2Y0<A?[`NXLi<qIdaMs]?xyQk2]o6WCyY7XU0D`tJL<L8"
559,1
928,1
593,
594,
...
2
590,5
CubeName,"}APQ Security Effective Client Application Folder Permissions"
pClient,"Total APQ Clients"
pGroup,"Total APQ Groups"
pObject,"}Applications"
pAccess,"Value"
637,5
CubeName,""
pClient,""
...
### Params
pDoProcessLogging = 1;
sProcLogParams = 'CubeName:' | CubeName |' & '| 'pObject:' | pObject |' & '| 'pClient:' | pClient;
### Params
...
cCubTgt = '}APQ Security Effective Client Application Folder Permissions';
...
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}APQ Security Effective Client Application Folder Permissions','zDrill to Groups conferring access rights');
#****End: Generated Statements****
