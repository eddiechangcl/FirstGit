601,100
602,"Sys.Menu.Cube.Sys Menu Application Entry.Reset.Entry.DisplayName"
562,"SUBSET"
586,"Sys Menu Application Entry"
585,"Sys Menu Application Entry"
564,
565,"jJan:74`JVajRNkxEMC`Yo:g@ThixLD7blxMIQ2P_?V1qcRlXASvWNZ8gSXf]M4a>iXv3dEENHc[C54AJFtNE4nAL<jTKqtQ7\_QmcFeTpj9UAxcqtlB>>@eVd\[E]O\nojgbJJsa33dSFtp0zSEs9s0jU:ng?^]odsPeiaq;zyHai2``cFoqHlC>CL]:0q7ec\PQv[V"
559,1
928,0
593,
594,
...
pDoProcessLogging,"1"
pDebug,"0"
pSourceName,"Entry Name"
pTargetName,"Entry Display Name en"
637,4
pDoProcessLogging,"Log to the process logging cube (0 = False, 1 = True)"
pDebug,"Write debug log file?"
pSourceName,"Source Entry Name"
pTargetName,"Target Entry Name"
577,1
vElement
578,1
2
...
##############################################################################################################
# PURPOSE:
#    to copy original entry name to display name
# 
# DATA SOURCE:
#    none
#
...
cRootEl = '}Applications';


cSourceMeasure = pSourceName;
cTargetMeasure = pTargetName;
...
IF (vElement @= cRootEl );
    CellPutS ('Home Page', cCube, vElement, cTargetMeasure);
ENDIF;

### Copy Entry Name to Entry Display Name
sName = CellGetS (cCube, vElement, cSourceMeasure);
CellPutS (sName, cCube, vElement, cTargetMeasure);
