601,100
602,"Sys.Sync.Cube.Data.ImportFromFile"
562,"CHARACTERDELIMITED"
586,"C:\TM1\Bedrock\Data\Bedrock.Z.Cube.Placeholder.csv"
585,"C:\TM1\Bedrock\Data\Bedrock.Z.Cube.Placeholder.csv"
564,
565,"n1Fb=[hsck;BHva4qc:haBv?FF;BM[kDnf3oZPPNLTz14BGs0ZMyzP;gwhBbeeFlReAa:8MCfBN3YLRNC8LM?Dhf0dxs@WRB=]lsv3;n8V=1h_HPBKS5z:98vXVzMt3Iq>>^6SYTM5@wF[FKS7_g6NYybXd7MgIt>^_xLnEsBg_B;aws0FWlVe7T;e]=s3<al[DiHkR1"
559,1
928,0
593,
594,
...
cProcess = 'Sys.Transfer.Bedrock.Cube.Data.ImportFromFile';
  ...
  If( nDimensionCount = 2 );
    If( CellIsUpdateable( pCube, v2, v3 ) = 1 );
      ...
      IF( sElType @= 'AS' % sElType @= 'AA');
        ATTRPUTS( v4, sDim1, v2, v3 );
      ELSEIF( sElType @= 'AN' );
        ATTRPUTN( Numbr( v4), sDim1, v2, v3 );
      ElseIf( sElType @= 'S' );
