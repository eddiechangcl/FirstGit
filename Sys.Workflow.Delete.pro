601,100
602,"Sys.Workflow.Delete"
562,"NULL"
586,
585,
564,
565,"aaldn[WR<7@[]UeuG4BKxi7>QjqgdxrDy[y`ULJXCiT87vCzKXInTZhDuq@Gx0jMFy7_oaLkBiIQePF@DAsvPclx7f0r4UOX^O:gry_YY6x6ICn2ZNL<V7tKEqv6wUGxG;d69nxHZY0<]@?TMr\g\>]LU`4OQ]m?2Nc?39Heb7ftnbgOk0iAb]<q=>DEmMiYDDG7U_MW"
559,1
928,0
593,
594,
...
cWorkflow = pWorkflow;
cCubeWorkflow = 'Sys Workflow '|cWorkflow;
...
sValidation001 = cCubeWorkflow; sDimValidation001 = '}Cubes'; sEmptyError001 = 'Workflow cannot be empty.'; sInvalidError001 = 'Invalid Workflow: ' | cCubeWorkflow;
nValidations = 1;
...
If (CubeExists(cCubeWorkflow) = 1);
    CubeDestroy(cCubeWorkflow);
Endif;

If (DimIx(cDimWorkflow, cWorkflow) <> 0);
    DimensionElementDelete(cDimWorkflow, cWorkflow);
EndIf;
