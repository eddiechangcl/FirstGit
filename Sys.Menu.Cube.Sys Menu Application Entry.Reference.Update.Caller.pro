601,100
602,"Sys.Menu.Cube.Sys Menu Application Entry.Reference.Update.Caller"
562,"SUBSET"
586,"}ApplicationEntries"
585,"}ApplicationEntries"
564,
565,"kqDA;3\]Z9GanL;XpdyJ5Ny9EgMhDq4`j`^yM`wzn>j8=\6`8o[1`7kr;a8[>z=fbeWG`EyU7<t6[:zs9HQElC3kxhmLT`8goXH6qgs?klEeWQkngxTswQogmXyfGOg:yfcgWA192lv;0XfLwRVk6JoDnRqxTLBpm6wUffwi<K8@K3V_hIW@P:2GO7p;1SLlN0]4k8<X"
559,1
928,0
593,
594,
...
##############################################################################################################
# PURPOSE:
#    to update App Entry Reference - Caller
# 
# DATA SOURCE:
#    none
#
...
If (SubSt(vElement, Long(vElement) - 4, 5) @= '.blob'
     % SubSt(vElement, Long(vElement) - 4, 5) @= '.view'
     % SubSt(vElement, Long(vElement) - 4, 5) @= '.extr'
    );
    sProcess = 'Sys.Menu.Cube.Sys Menu Application Entry.Reference.Update';
    sParam1Name = 'pDoProcessLogging';
    sParam1Value = '1';
    sParam2Name = 'pElement';
    sParam2Value = vElement;
...
ExecuteProcess('}APQ.Dim.Sub.SemiDynamicSubsets.Update',
   'pDoProcessLogging', '1',
   'pDim', 'Sys Menu Application Entry',
   'pForce', '0'
  );

ExecuteProcess('Sys.Menu.Cube.Sys Menu Application Entry.Reset.Entry.DisplayName',
   'pDoProcessLogging', '1',
   'pDebug', '0',
