601,100
602,"Sys.Menu.Dim.Sys Menu Local Template.List.Caller"
562,"NULL"
586,
585,
564,
565,"v]P`S\X7AD2Xvm\p5DJ77]aaJje9`IE`OoDy3JyNJ@5r]=7vD`A>CZYZX2;I:fazy7D=3hCtCr_qS0>RNRr?[:tc=[1phMxBnq]Osb:hz?yD6xxV@g:Y@t^DmseIMnst4Rps0p\\jK`[6CqfCe^b?`[l7wI;bHLnRIfiOxwvA3BI22PNA9I_IA7ss:LLxjD9o[HrV0eE"
559,1
928,0
593,
594,
...
sOutputDir =  CellGetS(cSystemParameterCube,'Export Folder','Text');
sOutputFile = cProcessName | '_' | NumberToString(Rand()) | '.txt';

cRootDirectory = CellGetS(cSystemParameterCube, 'Static Report IIS Virtual Directory Path', 'Text');
cDim = CellGetS(cSystemParameterCube, 'Static Report Listing Dimension', 'Text');

sProcess = 'System.Directory.List';
sParam1Name = 'pRootDirectory';
sParam1Value = cRootDirectory;
sParam2Name = 'pFileName';
sParam2Value = sOutputFile;
...
sProcess = 'System.Dim.Static Report Virtual Directory.List.Update';
sParam1Name = 'pRootDirectory';
sParam1Value = cRootDirectory;
sParam2Name = 'pDimension';
sParam2Value = cDim;
sParam3Name = 'pListFilePath';
sParam3Value = sOutputDir|'\'|sOutputFile;
