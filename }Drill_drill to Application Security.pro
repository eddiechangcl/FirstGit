601,100
602,"}Drill_drill to Application Security"
562,"VIEW"
...
564,
565,"q7O`wB9T_7IiBmUUYaYJjo2pry6f0vTFmU4^36nJ6i28Wxd<DO\spA:D9AC_9H<mJ2mbD@eg5hnQE3isz?WPxk]@v4g1k[mxDgMIO9i>lze>k1kP_D2h`>7w=wXlcf=fY>WG5OxcxDTleLbgd;^MM=gIxm>vn;5LLy0d8dE=S^BT4kMg_ES7owDUCsJT\n\KEEP1_[IY"
559,1
928,1
593,
594,
...
589,
568,""""
570,zDrill to Application Security
571,
569,0
592,0
599,1000
...
cViewTgt = 'zDrill to Application Security';
...
IF( 1 = 0 );
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}APQ Security Effective Client Application Folder Permissions','zDrill to Application Security');
#****End: Generated Statements****
