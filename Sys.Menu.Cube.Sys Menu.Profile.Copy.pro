601,100
602,"Sys.Menu.Cube.Sys Menu.Profile.Copy"
562,"NULL"
586,
585,
564,
565,"u5FHJ_dtIGeKu[QvNVM41aD18fk<;40mm:Y6\4:RC>vvTww4S@zoE5]dFBHxbP=X^T6U46XCFuCDa5WsOPM@fL`VT\[[WpA<T7^E@l_1X6>qZpt]i:ze4I[[T`Y9am5yFt[xSJK[\7E0XvuG3SoqMgo4S;`B<vx6_jaBm5Kr>gWKZ5f2kZERr9;O8g?9m5X?lpoy8U`S"
559,1
928,0
593,
594,
...
##############################################################################################################
# PURPOSE:
#    to copy entire menu profile to another profile
# 
# DATA SOURCE:
#    none
#
...
sDim = cPageDim;
sMDX = '{Descendants([' | cPageDim | '].[' | cRootPage | '])}';
...
nSubsetSize = SubsetGetSize( cPageDim, cSub );
nSubsetIndex = 1;
While( nSubsetIndex <= nSubsetSize );
      sPageElement = SubsetGetElementName( cPageDim, cSub, nSubsetIndex );

      sProcess = 'Sys.Menu.Cube.Sys Menu.Page.Copy';
      sParam1Name = 'pSourceClient';
      sParam1Value = cSourceClient;
      sParam2Name = 'pTargetClient';
      sParam2Value = cTargetClient;
      sParam3Name = 'pSourcePage';
      sParam3Value = sPageElement;
      sParam4Name = 'pTargetPage';
      sParam4Value = sPageElement;
