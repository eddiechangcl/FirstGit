601,100
602,"Sys.Workflow.WF_.Update Saved Status.OPEN"
562,"SUBSET"
586,"MCCr"
585,"MCCr"
564,
565,"df40a?k5HSORMV:9<;NC<4ttypWpK59TPV?MoX4:l`cMB?k]qf27mdT?99w2=^X[jzYUX>sxPd_3[2B5be\9c@9[MqD<tm_thf>hTQ;<D\CvKo4i0=^6:W27i;R3t[Af6`7NoOiJ\XEC2Rj@WHVa7x^ee3>EP0[9Z\DoYRA4p`6k=R\EV>BaFUhkb4L=y63]1YP]gFxG"
559,1
928,0
593,
594,
...
#Validate both Empty and Invalid
sValidation001 = cNode; sDimValidation001 = cDimPlanningUnit; sEmptyError001 = 'Node cannot be empty.'; sInvalidError001 = 'Invalid Planning Unit Node: ' | cNode;
nValidations = 1;
