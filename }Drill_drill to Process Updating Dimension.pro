601,100
602,"}Drill_drill to Process Updating Dimension"
562,"VIEW"
586,"}APQ Process to Object Reference"
585,"}APQ Process to Object Reference"
564,
565,"f>LRswaetj3z;8wOaa]K6ePCkZ40R\@EQxfuPJN:XIZfg>yOXSw^d9NgItyxWM?`5iDc:GjdVbp:oO:87?AfTODcX[k2t1FXT2H^ob;v?17t3]@\4p?Wy3kz2hiYtyZ@Kj`nj:XTI]d`4tzn>ERlOee>KZz[6VR6HR@N9PqTVgL41np8one:b;9zrwBJ7vFpe[e>?B[x"
559,1
928,1
593,
594,
...
589,
568,""""
570,zDrill to Process Updating Dimension
571,
569,0
592,0
599,1000
...
cViewTgt = 'zDrill to Process Updating Dimension';
cDimTyp = '}APQ TM1 Object Type';
cDimTgt = '}APQ TM1 Objects';
cSubTgt = cViewTgt;

# As object type and object match between source & target cube and are on title there is no need to do any view or subset manipulation to make the drill work
...
IF( 1 = 0 );
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}APQ Process to Object Reference','zDrill to Process Updating Dimension');
#****End: Generated Statements****
