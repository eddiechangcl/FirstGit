601,100
602,"Sys.Menu.Dim.Sys Menu Application Entry.Clean Empty C Elements"
562,"SUBSET"
586,"}ApplicationEntries"
585,"}ApplicationEntries"
564,
565,"wH35tXTsrQiWN8JMp[Evp]4a]fG]Q[<BBuv14\<CvWI2k93hO`q6xcFpD1rZ_AV988HE7YcfIcEy15xMBKFS`;YvdsEh<=mFk_S0@:M9PDiN>dUhzsPUCJr0K7Ter\Mimx8PXfGA:Kzj<ABcNIrKmnqI:`VJb8DIVB3NwHo]npp>UUe;iYj`Ymta:TCt[6YFVL`x1>P2"
559,1
928,0
593,
594,
...
##############################################################################################################
# PURPOSE:
#    to remove Emply folder from Sys Menu Application Entry Dimension
# 
# DATA SOURCE:
#    none
#
...
cDimSource = 'Sys Menu Application Entry';
...
IF( sElType @= 'C' & CellGetN(cCube, vElement, 'Entry Count Total') = 0);
    DimensionElementDelete( cDimSource, vElement);
EndIf;
