601,100
602,"}Drill_Drill to Cell Comments (7)"
562,"VIEW"
586,"}CellComments_APQ.Demo Sales Summary"
585,"}CellComments_APQ.Demo Sales Summary"
564,
565,"w;qkO2Gs\8_HByCftM^<iN7aX;m3F4UwcHFmx::M_Ckk3a:EQkvpGbjVkpzE^M^Z`?G@y`^Qmsfslw;4Lb;GKI82P_4=ceHPa5:EKemX`IQ\t_x6`vtGwl7;zvF^`0SNC7ngmW2=gAq>Wrv0\fE@RMRa?yo_ToenmYXOkfFcb=]SUvq<P2Br4D8ML?in8tMXEU:q8<^U"
559,1
928,1
593,
594,
...
2
590,8
CubeName,"Sales Summary"
pDim1,"ACT"
pDim2,"All Years"
pDim3,"Quarter Rollups"
...
IgnoredInputVarName=QuarterVarType=32ColType=1165
IgnoredInputVarName=CustomerVarType=32ColType=1165
...
######################
### Purpose:
### For any cube ( with 7 dimensions ). Drill through to the cell commentary
...
### Params
pDoProcessLogging = 1;
sProcLogParams = 'CubeName:' | CubeName |' & '| 'pDim1:' | pDim1 |' & '| 'pDim2:' | pDim2 |' & '| 'pDim3:' | pDim3 |' & '| 'pDim4:' | pDim4 |' & '| 'pDim5:' | pDim5 |' & '| 'pDim6:' | pDim6 |' & '| 'pDim7:' | pDim7;
### Params
...
IF( 1 = 0 );
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}CellComments_APQ.Demo Sales Summary','zDrill to Cell Comments');
#****End: Generated Statements****
