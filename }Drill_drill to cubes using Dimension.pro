601,100
602,"}Drill_drill to cubes using Dimension"
562,"VIEW"
586,"}APQ Dimension Use"
585,"}APQ Dimension Use"
564,
565,"y`fm4navx=Wo09pxo?BfRaTUja5Scl\sE^Uu0IVXfemvNRZGHljj\[T17ftD1D^;jPkHwOAB;YufPabd0GXg?>kRrp9>20:@@h8O8_N=WnP@s5bDQ`?_Y4lVW=7axTcmz\mEK^hplOrwG^7Q:>UO4XB?KKcF3yrTA<vQjVXL3uz3`>sLt64LP@Z8^VIVH<c:uzW_KX4A"
559,1
928,1
593,
594,
...
589,
568,""""
570,Find Cubes where Dim is used
571,
569,0
592,0
599,1000
...
cViewTgt = 'Find Cubes where Dim is used';
cDimTgt = '}APQ Dimensions';

sDim = pObject;
iDim = DimIx( cDimTgt, sDim ) - 1;
IF( iDim * ViewExists( cCubTgt, cViewTgt ) > 0 );
  ViewTitleDimensionSet( cCubTgt, cViewTgt, cDimTgt );
  ViewTitleElementSet( cCubTgt, cViewTgt, cDimTgt, iDim );
EndIF;
...
IF( 1 = 0 );
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}APQ Dimension Use','Find Cubes where Dim is used');
#****End: Generated Statements****
