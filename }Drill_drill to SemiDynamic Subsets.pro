601,100
602,"}Drill_drill to SemiDynamic Subsets"
562,"VIEW"
586,"}APQ Dimension SemiDynamic Subsets"
585,"}APQ Dimension SemiDynamic Subsets"
564,
565,"iD;yMf>i0a:zWJw=^<6Bi]RoahrUgj3YV7PxZO5]wZOTN@mO9^y<YX_nWezl\DdX]JVWhqRM^@wvaR_Vipil2\p8q?DWOpALi67snO\=m0sfUW5JgE@=Ek:ibc]2_0wOCh8;>bgOF<Rj5aP3^bfEIZSshQ7A<LQC=nY8lJysodVI8lDo?uxUgpoSm[UE?C5RiKhwAjg]"
559,1
928,1
593,
594,
...
589,
568,""""
570,zDrill to SemiDynamic Subsets
571,
569,0
592,0
599,1000
...
cViewTgt = 'zDrill to SemiDynamic Subsets';
...
IF( DimIx( cDimTgt, sDim ) > 0 );
  ...
  EndIF;
  SubsetElementInsert( cDimTgt, cSubTgt, sDim, 1 );
...
IF( 1 = 0 );
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}APQ Dimension SemiDynamic Subsets','zDrill to SemiDynamic Subsets');
#****End: Generated Statements****
