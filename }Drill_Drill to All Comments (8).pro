601,100
602,"}Drill_Drill to All Comments (8)"
562,"VIEW"
586,"}CellComments_APQ.Demo Sales Cube"
585,"}CellComments_APQ.Demo Sales Cube"
564,
565,"fLjP50aCP6ZFp?s3NGceu85@o;Tl82wmyO?gtgjbS]F]oxgJN1M_;a;M_QsGRARj?kyD=9K:4=W@zvYfuBmIer0XFb_6fvV2Ff@809`Jw0HkW[74RsP\xF[Jq2[C?XePfujZWeGVqBa3q@zNZiU3nn^?ogBUkpMPCezs[beh;h<GWDp5LL9Bstp:?lA:SWVSADUc>9[Z"
559,1
928,1
593,
594,
...
### Params
pDoProcessLogging = 1;
sProcLogParams = 'CubeName:' | CubeName |' & '| 'pDim1:' | pDim1 |' & '| 'pDim2:' | pDim2 |' & '| 'pDim3:' | pDim3 |' & '| 'pDim4:' | pDim4 |' & '| 'pDim5:' | pDim5 |' & '| 'pDim6:' | pDim6 |' & '| 'pDim7:' | pDim7 |' & '| 'pDim8:' | pDim8;
### Params
...
IF( 1 = 0 );
#****Begin: Generated Statements***
RETURNVIEWHANDLE('}CellComments_APQ.Demo Sales Cube','Default');
#****End: Generated Statements****
