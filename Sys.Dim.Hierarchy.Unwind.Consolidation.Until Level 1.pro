601,100
602,"Sys.Dim.Hierarchy.Unwind.Consolidation.Until Level 1"
562,"SUBSET"
586,"}Cubes"
585,"}Cubes"
564,
565,"df1ca=rFGp<<<jY42>VExe4vmpW:IQ<l<jE;Z<hm;f=vE;_k1UB<DEr>dvJ@:LlGe7f[OD^JWrrXhAH@]lOKccAntKPbfW7=MPqyQVNVPgZ2\^FY11f0ZNsnj?fhwD]BcbUoEaF4w;0X\s7Zw@xQfh\P8D7^39Rc2NBHi7f8^JjmXdFK4XW:yG?S[Zd;E6CeGdZeY50z"
559,1
928,0
593,
594,
...
While( nChildren > 0 & ElLev(pDimension, pConsol) > 1 );
...
If( ElLev( pDimension, vElement ) <= 1 );
  ItemSkip;
EndIf;
