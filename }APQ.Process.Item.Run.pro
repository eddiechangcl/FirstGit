601,100
602,"}APQ.Process.Item.Run"
562,"VIEW"
586,"}APQ Process Execution Item"
585,"}APQ Process Execution Item"
564,
565,"jClfmW@4Lhaf9gfIzQGOmx5Et`rIG_QMt7yZCW9gpMENr>J2MietjvCYXHQYc@<U=dBbQd=;q5>^8ZZ5o9cwj@i84;WmaDmrl5nVa<doiUpJU4qiSb]gngE=K8Z7QvYePw:b6cQFZJ_ZB\L_\^mgUrm1d9>OLYUpICok;=UUEa;Ib7KB01dtp0fqz<qpyxS6@2Ji5faE"
559,1
928,0
593,
594,
...
timeStart   = NOW;
dateStart   = TIMST( timeStart, CellGetS('}APQ Settings', 'Date Time format','String') );
...
timeFinish  = NOW;
elapsedTime = TIMST( timeFinish - timeStart, CellGetS('}APQ Settings', 'Time format','String') );
dateFinish  = TIMST( timeFinish, CellGetS('}APQ Settings', 'Date Time format','String') );
